    ...
    >
      ...
      <Container className="relative" >
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none pt-45"  id="features">
          ...
          CorpAI provides cutting-edge platforms and tools designed to accelerate AI adoption and drive business transformation. Our solutions enable organizations to:
          </p>
        </div>
        <TabGroup
