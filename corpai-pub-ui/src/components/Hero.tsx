    ...
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      ...
      Transforming Organizations into {' '}
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">AI-Driven Enterprises</span>
        </span>{' '}
      </h1>
      ...
      <div className="mt-15 mb-10 lg:mt-15 lg:mb-10">
        ...
        >
          {[
            [
              { name: '', description: 'CorpAI bridges this gap by enabling businesses to seamlessly integrate AI-driven technologies into their workflows. Our mission is to empower enterprises with agentic AI solutions that facilitate secure, compliant, and intuitive interactions with siloed data sources and enterprise applications—turning complexity into simplicity.' },
